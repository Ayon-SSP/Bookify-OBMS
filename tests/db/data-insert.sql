...
INSERT INTO tbl_user_review (book_id, customer_id, book_rating, book_review, review_date) VALUES ('bo00002', 'cu00001', 0.5, 'This book was absolutely captivating! The storyline kept me engaged from beginning to end, and the characters were well-developed and relatable. I highly recommend it to anyone who enjoys [genre of the book]', SYSDATE);
INSERT INTO tbl_user_review (book_id, customer_id, book_rating, book_review, review_date) VALUES ('bo00003', 'cu00002', 0.2, 'I found the plot to be predictable and the characters to be one-dimensional. I would not recommend this book to others.', SYSDATE - INTERVAL '2' DAY);
INSERT INTO tbl_user_review (book_id, customer_id, book_rating, book_review, review_date) VALUES ('bo00004', 'cu00003', 0.3, 'The writing style was engaging, but the plot lacked some originality.', SYSDATE - INTERVAL '5' DAY);
INSERT INTO tbl_user_review (book_id, customer_id, book_rating, book_review, review_date) VALUES ('bo00005', 'cu00001', 0.4, 'A thought-provoking read that left me wanting more. The characters were complex and the themes were relevant.', SYSDATE - INTERVAL '7' DAY);
